...
$tmm = parse_ini_file(DROOT.'/ini/config.ini.php', 1);

/* Prefix Database */
define('DB', $tmm['database']['prefix']);
define('PROJECT_TITLE', $tmm['http']['default_title']);
/* Main Global */
$TPL = array('TITLE' => PROJECT_TITLE);

/* verzeichnisse */
define('WEB', $tmm['http']['webroot']);

define('CLASSDIR', DROOT.'/tff/');
define('TPL_DIR', DROOT.DIRECTORY_SEPARATOR.$tmm['view']['template']);
